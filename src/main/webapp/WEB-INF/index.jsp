...
<head>
    ...
    <![endif]-->
    <%--<link rel="*" href="../fonts/feather-webfont.ttf"/>--%>
    <%--<link rel="*" href="../fonts/feather-webfont.woff"/>--%>
    <%--<link rel="*" href="../fonts/socicon.ttf"/>--%>
    <%--<link rel="*" href="../fonts/socicon.woff"/>--%>
        ...
        <div class="row">
            ...
            <div class="col-sm-8 text-right">
                <ul class="list-inline top-dark-right">
                    ...
                    <li><a class="topbar-icons" href="index.html#"><span><i class="fa fa-search top-search"></i></span></a>
                    </li>
                </ul>
                <div class="search">
                    <form role="form">
...
<div class="navbar navbar-default navbar-static-top yamm sticky" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html"><img src="img/logo.jpg" alt="h"></a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown active ">
                    ...
                    <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                        ...
                        <%--<li><a href="home-fl0exslider.html">Flex slider</a></li>--%>
                        <%--</ul>--%>
                        <%--</li>--%>
                        <%--<li class="dropdown-submenu">--%>
                ...
                <li class="dropdown">
                    <a href="index.html#" class="dropdown-toggle " data-toggle="dropdown"> poxel <i
                            class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu multi-level" role="menu">
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="index.html#">Արագածոտն </a>
                            <%--<ul class="dropdown-menu">--%>
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="index.html#">Արարատ </a>
                            <%--<ul class="dropdown-menu">--%>
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="index.html#">Արմավիր </a>
                            <%--<ul class="dropdown-menu">--%>
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="index.html#">Գեղարքունիք</a>
                            <%--<ul class="dropdown-menu">--%>
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="index.html#">Լոռի </a>
                            <%--<ul class="dropdown-menu">--%>
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="index.html#">Կոտայք </a>
                            <%--<ul class="dropdown-menu">--%>
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="index.html#">Շիրակ</a>
                            <%--<ul class="dropdown-menu">--%>
                ...
                <li class="dropdown">
                    <a href="index.html#" class="dropdown-toggle" data-toggle="dropdown">Blog <i
                            class="fa fa-angle-down"></i></a>
                ...
                <li class="dropdown">
                    <a href="index.html#" class="dropdown-toggle" data-toggle="dropdown">Pages <i
                            class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu" role="menu">
                ...
                <li class="dropdown">
                    <a href="index.html#" class="dropdown-toggle" data-toggle="dropdown">Regions <i
                            class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu">
                        <%--<li class="dropdown-submenu">--%>
                            <%--<a tabindex="-1" href="index.html#">Արագածոտն </a>--%>
                            <%--&lt;%&ndash;<ul class="dropdown-menu">&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="index.html">Header 1 - Default</a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="header-dark.html">Header 2 - dark </a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="header-transparent.html">header 3 - transparent </a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="header-center-logo.html">header 4 - Logo center </a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="header-side-panel.html">header 5 - Side panel </a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;</ul>&ndash;%&gt;--%>
                        <%--</li>--%>
                        <%--<li class="dropdown-submenu">--%>
                            <%--<a tabindex="-1" href="index.html#">Արարատ </a>--%>
                            <%--&lt;%&ndash;<ul class="dropdown-menu">&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="index.html">Footer dark - 1</a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="footer-2.html">Footer dark - 2</a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="footer-3.html">Footer dark - 3 </a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="footer-light-1.html">Footer Light - 1</a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="footer-light-2.html">Footer Light - 2</a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="footer-light-3.html">Footer Light - 3 </a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;</ul>&ndash;%&gt;--%>
                        <%--</li>--%>
                        <%--<li class="dropdown-submenu">--%>
                            <%--<a tabindex="-1" href="index.html#">Արմավիր </a>--%>
                            <%--&lt;%&ndash;<ul class="dropdown-menu">&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="full-width.html">Full Width</a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="left-sidebar.html">Left Sidebar</a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="right-sidebar.html">Right sidebar</a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="both-sidebar.html">Both Sidebar</a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="both-right-sidebar.html">Both Right sidebar</a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="both-left-sidebar.html">Both Left Sidebar</a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;</ul>&ndash;%&gt;--%>
                        <%--</li>--%>
                        <%--<li class="dropdown-submenu">--%>
                            <%--<a tabindex="-1" href="index.html#">Գեղարքունիք </a>--%>
                            <%--&lt;%&ndash;<ul class="dropdown-menu">&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="coming-soon-1.html">Coming soon 1</a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="coming-soon-2.html">Coming soon 2</a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<li><a href="coming-soon-3.html">Coming soon 3</a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;</ul>&ndash;%&gt;--%>
                        <%--</li>--%>
                        <c:forEach items="${allRegions}" var="region">
                            <li><a href="/rSinglePage?rId=${region.id}">${region.name} </a></li>
                        </c:forEach>
                        <%--<li><a href="maintenance-page.html">Կոտայք</a></li>--%>
                        <%--<li><a href="blank.html">Շիրակ</a></li>--%>
                        <%--<li><a href="error.html">Սյունիք</a></li>--%>
                        <%--<li><a href="invoice.html">Վայոց ձոր</a></li>--%>
                        <%--<li><a href="login-ragister.html">Login / Register</a></li>--%>
                        <%--<li><a href="login-ragister-classic.html">Login / Register - Classic </a></li>--%>
                        <%--<li><a href="invoice.html">Տավուշ</a></li>--%>
                        <%--<li><a href="site-map.html">Երևան</a></li>--%>
                    </ul>
                </li><!--features-->

                <!--mega menu-->
                <li class="dropdown yamm-fw">
                    <a href="index.html#" class="dropdown-toggle" data-toggle="dropdown">Shortcodes <i
                            class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu">
                        <li>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="center-heading">
                <h2> Մեր &nbsp նախնիներից &nbsp ժառանգած &nbsp<strong>հոյակերտ &nbsp վանքերը</strong></h2>
                <span class="center-line"></span>
            </div>
        </div>
    </div>
...
<div class="wide-img-showcase">
    ...
    <div class="row margin-0 wide-img-showcase-row">
        <div class="img/arpa.jpg" alt="">nael noric
        ...
        <div class="col-sm-6 col-sm-offset-6 no-padding gray">
            <div class="no-padding-inner gray">
                <h3 class="wow animated fadeInDownfadeInRight">Core features of <span class="colored-text">assan</span>
                </h3>
