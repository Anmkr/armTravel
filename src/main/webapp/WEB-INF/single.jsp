        ...
        <div class="row">
            <div class="col-sm-5 hidden-xs">
                <div class="top-bar-socials">
                    <a href="blog-single.html#" class="social-icon-sm si-gray si-gray-round si-facebook">
                        <i class="fa fa-facebook"></i>
                        <i class="fa fa-facebook"></i>
                    </a>
                    <a href="blog-single.html#" class="social-icon-sm si-gray si-gray-round si-twitter">
                        <i class="fa fa-twitter"></i>
                        <i class="fa fa-twitter"></i>
                    </a>
                    <a href="blog-single.html#" class="social-icon-sm si-gray si-gray-round si-g-plus">
                    ...
                    <a href="blog-single.html#" class="social-icon-sm si-gray si-gray-round si-instagram">
            ...
            <div class="col-sm-7 text-right">
                <ul class="list-inline top-dark-right">
                    ...
                    <li><a href="blog-single.html#"><i class="fa fa-lock"></i> Login</a></li>
                    <li><a href="blog-single.html#"><i class="fa fa-user"></i> Sign Up</a></li>
                    <li><a class="topbar-icons" href="blog-single.html#"><span><i class="fa fa-search top-search"></i></span></a></li>
                </ul>
                <div class="search">
                    <form role="form">
    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a href="blog-single.html#" class="dropdown-toggle" data-toggle="dropdown">Home <i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="blog-single.html#">Sliders </a>
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="blog-single.html#">Revolution 5</a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="blog-single.html#">Multi level menu </a>
                            <ul class="dropdown-menu">
                                <li><a href="blog-single.html#"> menu level 2</a></li>
                                <li class="dropdown-submenu">
                                    <a tabindex="-1" href="blog-single.html#">menu level 2 </a>
                                    <ul class="dropdown-menu">
                                        <li><a href="blog-single.html#"> menu level 3</a></li>
                                        <li><a href="blog-single.html#"> menu level 3</a></li>
                                    </ul>
                                </li>
                            </ul>
                ...
                <li class="dropdown">
                    <a href="blog-single.html#" class="dropdown-toggle " data-toggle="dropdown">Portfolio <i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu multi-level" role="menu">
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="blog-single.html#">Cube Portfolio </a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="blog-single.html#">Grid Text Boxed </a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="blog-single.html#">Grid Boxed </a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="blog-single.html#">No space Full width </a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="blog-single.html#">No Space Boxed </a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="blog-single.html#">Portfolio Masonry </a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="blog-single.html#">Portfolio Items</a>
                            <ul class="dropdown-menu">
                ...
                <li class="dropdown active">
                    <a href="blog-single.html#" class="dropdown-toggle" data-toggle="dropdown">Blog <i class="fa fa-angle-down"></i></a>
                ...
                <li class="dropdown">
                    <a href="blog-single.html#" class="dropdown-toggle" data-toggle="dropdown">Pages <i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="blog-single.html#">Contact </a>
                            <ul class="dropdown-menu">
                ...
                <li class="dropdown">
                    <a href="blog-single.html#" class="dropdown-toggle" data-toggle="dropdown">Features  <i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu">
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="blog-single.html#">Headers </a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="blog-single.html#">Footers </a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="blog-single.html#">Page Templates </a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                            <a tabindex="-1" href="blog-single.html#">Coming Soon </a>
                            <ul class="dropdown-menu">
                ...
                <li class="dropdown yamm-fw">
                    <a href="blog-single.html#" class="dropdown-toggle" data-toggle="dropdown">Shortcodes  <i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu">
                        <li>
...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            ...
            <ul class="pager">
                <li class="previous"><a href="blog-single.html#">&larr; Previous Page</a></li>
                <li class="next"><a href="blog-single.html#">Next Page &rarr;</a></li>
            </ul><!--pager-->
            ...
            <div class="col-md-3 col-sm-6 margin30">
                <div class="footer-col">
                    ...
                    <ul class="list-inline footer-social">
                        <li>
                            <a href="blog-single.html#" class="social-icon si-dark si-gray-round si-colored-facebook">
                                <i class="fa fa-facebook"></i>
                                <i class="fa fa-facebook"></i>
                            </a>
                        </li>
                        <li>
                            <a href="blog-single.html#" class="social-icon si-dark si-gray-round si-colored-twitter">
                                <i class="fa fa-twitter"></i>
                                <i class="fa fa-twitter"></i>
                            </a>
                        </li>
                        <li>
                            <a href="blog-single.html#" class="social-icon si-dark si-gray-round si-colored-google-plus">
                                <i class="fa fa-google-plus"></i>
                                <i class="fa fa-google-plus"></i>
                            </a>
                        </li>
                        <li>
                            <a href="blog-single.html#" class="social-icon si-dark si-gray-round si-colored-pinterest">
                                <i class="fa fa-pinterest"></i>
                                <i class="fa fa-pinterest"></i>
                            </a>
                        </li>
                        <li>
                            <a href="blog-single.html#" class="social-icon si-dark si-gray-round si-colored-linkedin">
            ...
            <div class="col-md-3 col-sm-6 margin30">
                <div class="footer-col">
                    ...
                    <ul class="list-unstyled contact">
                        ...
                        <li><p><strong><i class="fa fa-envelope"></i> Mail Us:</strong> <a href="blog-single.html#">Support@designmylife.com</a></p></li>
